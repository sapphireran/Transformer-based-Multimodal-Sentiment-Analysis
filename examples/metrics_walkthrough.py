...
def main() -> int:
    ...
    print()
    print(_fmt_edges(7))
    print("y bins7:", list(split_uniform_7(Y)))
    print("ŷ bins7:", list(split_uniform_7(YHAT)))
    print()
    print(_fmt_edges(5))
    print("y bins5:", list(split_uniform_5(Y)))
    print("ŷ bins5:", list(split_uniform_5(YHAT)))
    print()
